...
def get_infos_from_url(url, pas):
    ...
    url = "https://www.faune-france.org/index.php?m_id=94&&p_c=3&p_cc=-1&sp_tg=3&sp_DateSynth=09.04.2021&sp_DChoice=range&sp_DFrom=01.01.2020&sp_DTo=09.04.2021&sp_DCa=0&sp_SChoice=all&sp_PChoice=coord&sp_Coord[N]=%(max_lat)s&sp_Coord[W]=%(min_lon)s&sp_Coord[S]=%(min_lat)s&sp_Coord[E]=%(max_lon)s&sp_FChoice=list&sp_FGraphFormat=auto&sp_FMapFormat=none&sp_FDisplay=DATE_PLACE_SPECIES&sp_FOrder=ALPHA&sp_FOrderListSpecies=ALPHA&sp_FListSpeciesChoice=DATA&sp_FOrderSynth=ALPHA&sp_FGraphChoice=DATA&sp_DFormat=DESC&sp_FAltScale=250&sp_FAltChoice=DATA&sp_FExportFormat=XLS&sp_tg=1"
    infos_dict = {}
